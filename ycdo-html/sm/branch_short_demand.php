        ...
        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    elseif($store_quantity > ($min_limit-$quantity))
                                    { ?>
                                        ...
                                        <input type = "number" class = "form-control" name = "issue_quantity[]" value = "<?php echo $min_limit-$quantity; ?>" max = "<?php echo $store_quantity; ?>"/>
                                    <?php } 
                                    else{ ?>
                                        <input type = "hidden" name = "reg_item_id[]" value = "<?php echo $reg_item_id; ?>" />
                                        <input type = "hidden" name = "item_box_size[]" value = "<?php echo $item_box_size; ?>" />
	                    ...
	                    <tfoot>
	                        <tr>
	                            <td colspan = "10">
        	                        <div>
                                        <input type = "hidden" name = "br_id" value = "<?php echo $br_id; ?>" />
        	                            <input type = "submit" value = "ISSUE BRANCH SHORT DEMAND" id = "submit_btn" class = "btn btn-primary btn-sm" name = "process_branch_short_demand" />
        	                        </div>
	                            </td>
	                        </tr>
	                    </tfoot>
