...
<div class="row" style="margin: 0px;">
	...
	<div style="text-align: right;float: right;margin-right: 10px;">
		...
		<h3 style="color: red;"><?php echo $bk_branch_name; ?></h3>
		<h4 style="color: white;"><?php echo $bk_branch_address; ?></h4>
		<h4 style="color: white;"><?php echo $bk_branch_phone; ?></h4>
		<h3 style="margin-top: 350px;text-align: center;">USER: <?php echo $_SESSION['bk_name']; ?></h3>
	</div>
