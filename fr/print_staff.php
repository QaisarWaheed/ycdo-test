...
if (isset($_GET['staff_id']) && $_GET['staff_id'] != '') 
{
    ...
    $select = "SELECT * FROM `staff` INNER JOIN designations ON staff.designation_id = designations.designation_id WHERE `staff_id` = '$staff_id' ";
...
<body onafterprint="window.location.href = 'show_staff.php'">
    ...
    <table class = "table table-bordered">
            <tr>
                ...
                <th>DESIGNATION</th>
                <td><?php echo $designation_title; ?></td>
                <th rowspan = "6" colspan = "2" style = "text-align: center;">
                    <picture>
                    <img src="https://ozsaphire.vpreps.com/images/staff/<?php echo $staff_image_href; ?>" alt="LOADING" style="width:180px;hieght:180px;">
                    </picture>                    
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <td>JOINING DATE</td>
                <td><?php echo date_format(date_create($staff_joining_date), "d-M-Y"); ?></td>
                <td>BASIC SALARY</td>
                <td><?php echo $staff_bacis_salary; ?></td>
                <td>ALLOW LEAVE</td>
                <td><?php echo $staff_allowed_leaves; ?></td>
            </tr>
            <tr style = "text-align: center;">
