...
if(isset($_GET['lab_test_appoved_report_save']) && $_GET['lab_test_appoved_report_save'] != '')
{
    ...
    $lab_test_print_comments = $_GET['lab_test_print_comments'];
    $update = "UPDATE `lab_tests` SET `lab_test_print_comments` = '$lab_test_print_comments', `lab_test_print_created_by` = '$lab_user_id', `lab_test_print_created_at` = '$current_date', `lab_test_status_id` = '7' WHERE `lab_test_id` = '$lab_test_id' AND  `lab_test_status_id` = '6' ";
    ...
    // header('location: print_test_report.php?token_no='.$token_no);
    exit(0);
}
...
<body class = "p-2">
    ...
    <table class = "table table-bordered table-hover" style = "color: black'">
        ...
        <tr>
            ...
            <td><?php echo $lab_test_report_result; ?></td>
        </tr>
        <?php } } ?>
        <tr>
            <td colspan = "5">
                <label>TEST PRINT REPORT COMMENT</label>
                <input type = "text" name = "lab_test_print_comments" class = "form-control" />
            </td>
        </tr>
        <tr>
            <td colspan = "5">
                <input type = "hidden" value = "<?php echo $token_no; ?>" name = "token_no" />
                <input type = "submit" value = "SAVE TEST PRINT REPORT" name = "lab_test_appoved_report_save" class = "btn btn-info" />
