        ...
        <div class="col-md-12">
        	<form name="search" method="get" onsubmit="showProgress(); return true;">
        		...
        		<div class="col-md-2">
        			...
        			<input autofocus type="reset" name="" class = "btn btn-warning btn-sm" value="CLEAR">
        		</div>
        		<div>
        ...
        <div class="row">
            <div class="col-md-12">
                <fieldset class="border p-2">
                    <legend style="font-size: 14px;" class="w-auto">SELECT MEDICINE OR SERVICES</legend>
                    <div class="row">
                        <div class="col-md-6">
                        <form method = "POST" action = "action_save_test.php" autocomplete="off" onsubmit="showProgress(); return true;">
                            <input type = "hidden" name = "no_data" />
                            ...
                            <div class="col-md-12" style="text-align: right;" >
                                <input type = "hidden" name = "token_data" value = "1" />
...
<form onsubmit="return checknumber(this);" method = "POST" action = "action_save.php" autocomplete="off">
...
{ 
	...
	<div class="col-md-2">
		<label> Phone</label>
		<input readonly type="number" value="<?php echo $phone; ?>" min="0" class="form-control">
	</div>
	<div class="col-md-2">
		<label> Gender</label>
...
<?php
if (isset($patient_id, $name) && is_rehabilitation_branch($branch_id) && rehab_patient_has_fingerprints($con, $patient_id)) {
	rehab_fingerprint_verify_block();
}
?>
<?php }
else
