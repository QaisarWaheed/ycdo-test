...
<?php include 'includes/head.php'; ?>
	<title>PURCHASE DETAIL FROM <?php echo htmlspecialchars($from, ENT_QUOTES, 'UTF-8'); ?> TO <?php echo htmlspecialchars($to, ENT_QUOTES, 'UTF-8'); ?> - <?php echo $company_trademark; ?></title>
            ...
            <table class = "table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>'.$row_token['mfg_date'].'</td>
                        <td>'.$row_token['expiry_date'].'</td>
