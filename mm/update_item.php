...
if(isset($_POST['update']) && $_POST['update'] != '')
{
	...
	$available_quantity = get_store_item_quantity_from_item_id($up_id);
    ...
    echo '<script>location.replace("show_items.php")</script>';
    }
...
<?php       } ?>
						...
						<div class="col-md-6">
							...
							<input type="text" name="item_name" class="form-control" required value = "<?php echo $name; ?>" />
						</div>
						<div class="col-md-2">
							<label>STATUS</label>
