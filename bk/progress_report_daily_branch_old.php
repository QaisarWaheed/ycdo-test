...
if( isset($_POST['date']) && $_POST['date'] != '')
{
    $date = $_POST['date'];
    $br_id = $_POST['br_id'];
    echo '<script>window.open("print_progress_report_daily_branch.php?date='.$date.'&br_id='.$br_id.'", "DAILY PROGRESS REPORT", "width=3000,height=3000");</script>';
}
?>
...
<div class="row" style="margin: 0px;" id = "submitBody">
    ...
    <div class = "col-md-9">
        <form action = "progress_report_daily_branch.php" METHOD = "POST" class = "container" onsubmit="showProgress(); return true;">
        <div class = "row">
            <div class = "col">
                <label>BRANCH</label>
